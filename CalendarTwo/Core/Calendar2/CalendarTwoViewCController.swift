//
//  CalendarTwoViewCController.swift
//  CalendarTwo
//
//  Created by Samuel Fuentes Navarrete on 09/03/23.
//

import UIKit

struct DaysOfCalendar {
    var day: String
    var date: Date?
    var data: Any?
//    var typeOfMont: typeMonth?
//
//    enum typeMonth : String {
//        case currentMont = "CurrentMonth"
//        case previousMont = "PreviousMonth"
//        case nextMont = "NextMonth"
//    }
}



class CalendarTwoViewController : UIViewController {
    

    var selectedDate = Date()
    var totalOfDaysDispalyMonth = [DaysOfCalendar]()
...
//        setMonthView()
        ...
        var date = selectedDate.lastDayInMonth
        var days = [Int]()
        for _ in 1 ... 7 {
            let day = selectedDate.calendar.component(.day, from: date)
            days.append(day)
...
extension CalendarTwoViewController : UICollectionViewDataSource {
...
extension CalendarTwoViewController : UICollectionViewDelegateFlowLayout {
...
extension CalendarTwoViewController {
    ...
    func setDaysOfPreviousMont()
    {
        ...
        for _ in 1 ... 42 {
            ...
            if(count < startingSpaces)
            {
                ...
                totalOfDaysDispalyMonth.append(DaysOfCalendar(day: dayNumber))
                date = selectedDate.calendar.date(byAdding: .day, value: 1, to: date)!
                
            }
            else
            {
                totalOfDaysDispalyMonth.append(DaysOfCalendar(day: ""))
        ...
        func daysDisplayOfMonth2(){
            ...
            if (firstDayOfMonth <= lastDayOfMonth)
            {
                ...
                totalOfDaysDispalyMonth.append(DaysOfCalendar(day: dayNumber, date: strDate.date))
                day = selectedDate.calendar.date(byAdding: .day, value: 1, to: firstDayOfMonth)!
            }
            count += 1
        }
    ...
    func generateDay(dayNumber: String, day: Date, data: Any) -> DaysOfCalendar {
        
        return DaysOfCalendar(day: dayNumber, date: day, data: data)
    }
